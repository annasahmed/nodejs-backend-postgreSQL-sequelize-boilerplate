...
seeder 20240318100624-create-permissions is the seeder defined for permission

these permissions have been defined in the seeder
'users','place','appuser','role','page','notifications','home',
'filters' (subCategory, cuisine, usp, emirate ,area, neighbourhood),
'settings','seasons'

to add further permission use this api

POST {{baseurl}}/permission 
body:{
	"parent":"module_name" //module name should be route of that module like "place" for places module 
}
