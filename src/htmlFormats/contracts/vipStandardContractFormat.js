...
const vipStandartContractFormat = `<html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  li {
    ...
    <body>
        ...
        <header>VIP STANDARD PACKAGE PARTNER CONTRACT</header>
        <main>
            <section class="main-section">
                <div class="content-container">
                    <h3>Parties:</h3>
                    <p>
                        This agreement is entered into between Dubai Daily Deals and {{vendor_name}} for {{number_of_venues}} VIP Standard venue(s):
                    </p>
                </div>
                <div class="content-container">
                    <h3>Agreement:</h3>
                ...
                <div class="content-container">
                    ...
                    <ul>
                        ...
                        <li>Featured promotions and exclusive discounts for the Client's venue.</li>
                        ...
                        <li>Direct links to explore the menu offerings of the Client's venue.</li>
            ...
            <section class="main-section">
                ...
                <div class="content-container">
                    <h3>Duration:</h3>
                    <p>
                        This agreement shall be effective for a period of 13 months (1 month free trial and 12 months contract period) from the date of signing, unless terminated earlier as per the terms of this contract.
                    </p>
                </div>
                <div class="content-container">
                    <h3>Termination:</h3>
